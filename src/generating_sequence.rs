...
mod tests {
    ...
    fn test_subgroup_closure_dihedral() {
        ...
        let sub_s = GeneratingSequence::from_generators(&pres, std::slice::from_ref(&s));
        ...
        let sub_r = GeneratingSequence::from_generators(&pres, std::slice::from_ref(&r));
    ...
    fn test_subgroup_closure_quaternion() {
        ...
        let sub_x = GeneratingSequence::from_generators(&pres, std::slice::from_ref(&x_elem));
